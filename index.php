            ...
            <div class="expo"><?php
                ...
                if (isset($_GET['scanner']) or !empty($_SESSION['scanner'])) {?>
                    <div class="navsearch">
                        ...
                        <div class="search">
                            <form method="GET" action="index.php" id="suite">

                                <input id="reccode" style="width:90%; height: 30px;" type = "search" name = "scanneur" placeholder="scanner un produit" onchange="document.getElementById('suite').submit()">
                            </form>
                        </div>
                        <a href="index.php?vente"><input style="width: 100%;height: 30px; font-size: 20px; background-color: red;color: white;"  type="submit" value="Saisir"></a>
                    </div><?php
                    ...
                    if (!empty($_SESSION['scanner'])) {
                            ...
                            <div class="box">
                                ...
                                <ul style="margin-left: -35px; margin-top: -15px; margin-bottom: 20px;">                            
                                    <li class="logo">
                                        ...
                                        <a href="index.php?desig=<?= $product->designation;?>&idc=<?= $product->id;?>&pv=<?= $product->prix_vente;?>"><?php
                        ...
                        <div style="display: flex; margin-bottom: 30px;">
                            <div class="navs"><a style="text-decoration: none; color:white;" href="choix.php">ACCUEIL</a></div>
                            <div style="width:43%;">
                                <form method="GET" action="index.php" id="suite" name="term">

                                    <input id="reccode" style="width:90%; height: 30px;" type = "search" name = "terme" placeholder="rechercher un produit" onKeyUp="suivant(this,'s', 15)" onchange="document.getElementById('suite').submit()"/>
                            ...
                            <div>
                                <a href="index.php?scanner"><input name = "s" style="width: 100%;height: 30px; font-size: 20px; background-color: red;color: white;"  type="submit" value="Scanner"></a>
                            </div>
                        </div>
                    ...
                    if (isset($_GET['terme'])) {
                        ...
                        foreach ( $products as $product ){?>
                            ...
                            <div class="box">
                                <ul style="margin-left: -35px; margin-top: -15px; margin-bottom: 20px;">                            
                                    <li class="logo"><a href="index.php?logo=<?= $product->id; ?>">
