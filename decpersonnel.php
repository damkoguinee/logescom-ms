    ...
    if (isset($_POST['valid'])){         
      ...
      if (!isset($_GET['ajoutdep'])) {?>
        ...
        <table class="payement">
          ...
          <thead>
            <tr><th class="legende" colspan="12" height="30"><?="Liste des salaires payés " .$datenormale ?> <a href="decpersonnel.php?ajoutdep" style="color:orange; font-size: 20px;">Enregistrer un salaire</a></th></tr>
          ...
          $categorie=4;
            ...
            foreach ($products as $keyv=> $product ){
              ...
              <tr>
                ...
                <td><?php if ($_SESSION['level']>=6){?><a href="decpersonnel.php?deleteret=<?=$product->numdec;?>"> <input style="width: 100%;height: 30px; font-size: 17px; background-color: red;color: white; cursor: pointer;"  type="submit" value="Supprimer" onclick="return alerteS();"></a><?php };?></td>
