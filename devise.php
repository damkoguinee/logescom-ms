            ...
            <div>
              ...
              <tbody><?php 
                ...
                if (isset($_POST['j1'])) {
                  ...
                  $products= $DB->query('SELECT *FROM devisevente  WHERE lieuvente=? and motif=? order by(dateop) desc LIMIT 50', array($_SESSION['lieuvente']));
                }
            ...
            <div>
              ...
              <tbody><?php 
                ...
                if (isset($_POST['j1'])) {
                  ...
                  $products= $DB->query('SELECT *FROM devisevente  WHERE lieuvente=?  and motif=? order by(dateop) desc LIMIT 50', array($_SESSION['lieuvente'], 'achat devise'));
                }
