    ...
    if ($_SESSION['level']>=3) {
        ...
        if (!isset($_GET['ajoutdep'])) {?>
            ...
            <table class="payement">
              ...
              <thead>
                <tr><th class="legende" colspan="12" height="30"><?="Liste des Dépenses " .$datenormale ?> <a href="decdepense.php?ajoutdep" style="color:orange;">Enregistrer une dépense</a> <a href="printdepenses.php" target="_blank" ><img  style=" margin-left: 20px; height: 20px; width: 20px;" src="css/img/pdf.jpg"></a></th></tr>
                ...
                if (isset($_POST['j1'])) {
                  ...
                  if (isset($_POST['magasin']) and $_POST['magasin']=='general') {
                    ...
                    if ($_SESSION['level']>6) {
                        ...
                        $products= $DB->query('SELECT *FROM decdepense  WHERE lieuvente=:lieu order by(id) desc', array('lieu'=>$_SESSION['lieuvente']));
                    }
