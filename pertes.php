          ...
          <div>
            ...
            <table class="payement">
              ...
              <thead>
                ...
                <tr>
                  <th class="legende" colspan="5" height="30">Liste des Pertes <a href="pertes.php?ajoutpertes&nomstock=<?=$_SESSION['idnomstock'];?>" style="color: orange; margin-left: 30px;">Ajouter une Perte</a></th>
