...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : lun. 26 fév. 2024 à 11:06
...
--
-- Base de données : `u553146816_etsbmtmconakry`
--
...
CREATE TABLE `bannieres_entreprise` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `categorie` (
  ...
  `couverture` varchar(150) DEFAULT NULL,
  `img_produit` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`img_produit`)),
  `priorite` varchar(1) DEFAULT NULL,
...
INSERT INTO `collaborateurs` (`id`, `logo`) VALUES
(1, 'logodamko_65b3aa8be698f.jpg'),
(2, 'logoosam_65b3ab645cd9d.jpg'),
(3, 'logoets_65ba77923c842.jpg'),
(4, 'logoetsib_65ba779e1b0d4.jpg'),
(5, 'logomokolo_65ba77afb2ad9.jpg');
...
('DoctrineMigrations\\Version20240125144813', '2024-01-25 14:48:56', 385),
('DoctrineMigrations\\Version20240125151523', '2024-01-25 15:15:27', 21),
('DoctrineMigrations\\Version20240125164825', '2024-01-25 16:48:33', 44),
('DoctrineMigrations\\Version20240126095226', '2024-01-26 09:52:38', 178),
('DoctrineMigrations\\Version20240126095543', '2024-01-26 09:55:48', 68),
('DoctrineMigrations\\Version20240126112629', '2024-01-26 11:26:35', 103),
('DoctrineMigrations\\Version20240126154833', '2024-01-26 15:48:38', 71),
('DoctrineMigrations\\Version20240126163720', '2024-01-26 16:37:25', 59),
('DoctrineMigrations\\Version20240127101647', '2024-01-27 10:16:53', 94),
('DoctrineMigrations\\Version20240127111207', '2024-01-27 11:12:16', 37),
('DoctrineMigrations\\Version20240127111715', '2024-01-27 11:17:18', 134),
('DoctrineMigrations\\Version20240130123627', '2024-01-30 12:36:45', 122),
('DoctrineMigrations\\Version20240131171320', '2024-01-31 17:13:39', 199),
('DoctrineMigrations\\Version20240201141342', '2024-02-01 14:13:52', 250),
('DoctrineMigrations\\Version20240201142800', '2024-02-01 14:28:04', 88),
('DoctrineMigrations\\Version20240201143755', '2024-02-01 14:38:00', 78),
('DoctrineMigrations\\Version20240201144042', '2024-02-01 14:40:47', 26),
('DoctrineMigrations\\Version20240205091854', '2024-02-05 09:19:12', 135),
('DoctrineMigrations\\Version20240205141737', '2024-02-05 14:17:42', 107),
('DoctrineMigrations\\Version20240209122949', '2024-02-09 12:29:59', 127),
('DoctrineMigrations\\Version20240209161850', '2024-02-09 16:18:58', 69),
('DoctrineMigrations\\Version20240209162127', '2024-02-09 16:21:31', 77),
('DoctrineMigrations\\Version20240209170050', '2024-02-09 17:00:56', 233),
('DoctrineMigrations\\Version20240209170339', '2024-02-09 17:03:42', 78),
('DoctrineMigrations\\Version20240210211216', '2024-02-10 21:12:20', 183),
('DoctrineMigrations\\Version20240211184209', '2024-02-11 18:42:15', 334),
('DoctrineMigrations\\Version20240213122651', '2024-02-13 12:27:01', 100),
('DoctrineMigrations\\Version20240213131001', '2024-02-13 13:10:06', 28),
('DoctrineMigrations\\Version20240215115211', '2024-02-15 11:52:22', 270),
('DoctrineMigrations\\Version20240218112627', '2024-02-18 11:26:42', 292);
...
CREATE TABLE `entreprise` (
  ...
  `numero_agrement` varchar(255) DEFAULT NULL,
...
(1, 'ETS BMTB', 'L000058', 'jj00', 'Madina Ecole Gare Voiture Dabola', '620401473', 'logotahirou_65d4e96ad0bd1.jpg', NULL, NULL);
...
CREATE TABLE `epaisseurs` (
  `id` int(11) NOT NULL,
  `categorie_id` int(2) DEFAULT NULL,
  `valeur_epaisseur` float NOT NULL,
  `unite` varchar(15) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;
...
INSERT INTO `lieux_ventes` (`id`, `entreprise_id`, `gestionnaire_id`, `adresse`, `pays`, `region`, `ville`, `telephone`, `email`, `latitude`, `longitude`, `initial`, `type_commerce`) VALUES
(1, 1, 1, 'Madina Ecole Gare Voiture Dabola 620 40 14 73/ 669 97 97 57', 'guinée', 'Conakry', 'conakry', '620 40 14 73', 'zahrabarry38@gmail.com', 'hr9.6682033', '-13.5615839', 'bmt', 'vente des matériaux de construction et divers');
...
CREATE TABLE `liste_stock` (
  ...
  `nom_stock` varchar(150) NOT NULL,
  `adresse` varchar(255) NOT NULL,
...
CREATE TABLE `mouvement_product` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `products` (
  ...
  `statut_comptable` varchar(10) NOT NULL,
...
INSERT INTO `user` (`id`, `username`, `roles`, `password`, `nom`, `prenom`, `telephone`, `email`, `type_user`, `date_creation`, `lieu_vente_id`, `adresse`, `ville`, `region`, `pays`, `statut`) VALUES
(1, 'admin', '[\"ROLE_ADMIN\"]', '$2y$13$yu.eZp0kHBuwiCoEwaUTveWCf7TUhJod19J6QQjQnWNq1r2tdK22m', 'damko', 'damko', NULL, NULL, 'personnel', '2024-02-10', 1, 'nongo', 'conakry', 'conakry', 'guinée', 'actif');
...
--
-- Index pour la table `bannieres_entreprise`
--
ALTER TABLE `bannieres_entreprise`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `client`
  ...
  ADD KEY `IDX_C74404558E780FD` (`rattachement_id`);
...
ALTER TABLE `dimensions`
  ADD PRIMARY KEY (`id`),
  ADD KEY `IDX_E27D8BA5BCF5E72D` (`categorie_id`);
...
--
-- Index pour la table `epaisseurs`
--
ALTER TABLE `epaisseurs`
  ADD PRIMARY KEY (`id`),
  ADD KEY `IDX_9F8BBE8CBCF5E72D` (`categorie_id`);
...
ALTER TABLE `inventaire`
  ADD PRIMARY KEY (`id`),
  ADD KEY `IDX_338920E0CE430A85` (`inventaire_id`),
  ADD KEY `IDX_338920E04584665A` (`product_id`),
  ADD KEY `IDX_338920E0DCD6110` (`stock_id`),
  ADD KEY `IDX_338920E01C109075` (`personnel_id`);

--
-- Index pour la table `liaison_produit`
--
ALTER TABLE `liaison_produit`
  ADD PRIMARY KEY (`id`),
  ADD KEY `IDX_7F4F29C1FC0C3279` (`produit1_id`),
  ADD KEY `IDX_7F4F29C1EEB99D97` (`produit2_id`);

--
-- Index pour la table `lieux_ventes`
--
ALTER TABLE `lieux_ventes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `IDX_8FE8FCB7A4AEAFEA` (`entreprise_id`),
  ADD KEY `IDX_8FE8FCB76885AC1B` (`gestionnaire_id`);

--
-- Index pour la table `liste_inventaire`
--
ALTER TABLE `liste_inventaire`
  ADD PRIMARY KEY (`id`),
  ADD KEY `IDX_2163BD761C109075` (`personnel_id`),
  ADD KEY `IDX_2163BD76AA2B41DC` (`lieu_vente_id`);

--
-- Index pour la table `liste_stock`
--
ALTER TABLE `liste_stock`
  ADD PRIMARY KEY (`id`),
  ADD KEY `IDX_54CD82CEAA2B41DC` (`lieu_vente_id`),
  ADD KEY `IDX_54CD82CE53C59D72` (`responsable_id`);
...
--
-- Index pour la table `mouvement_product`
--
ALTER TABLE `mouvement_product`
  ADD PRIMARY KEY (`id`),
  ADD KEY `IDX_1C8AD1BAEBCD91F6` (`stock_product_id`),
  ADD KEY `IDX_1C8AD1BA4584665A` (`product_id`),
  ADD KEY `IDX_1C8AD1BAAA2B41DC` (`lieu_vente_id`),
  ADD KEY `IDX_1C8AD1BA1C109075` (`personnel_id`),
  ADD KEY `IDX_1C8AD1BA19EB6921` (`client_id`),
  ADD KEY `IDX_1C8AD1BACE430A85` (`inventaire_id`);

--
-- Index pour la table `origine_produit`
--
ALTER TABLE `origine_produit`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `personnel`
  ADD PRIMARY KEY (`id`),
  ADD KEY `IDX_A6BCF3DEA76ED395` (`user_id`);
...
ALTER TABLE `products`
  ...
  ADD KEY `IDX_B3BA5A5A35810E93` (`epaisseur_id`),
  ADD KEY `IDX_B3BA5A5A277428AD` (`dimension_id`),
  ADD KEY `IDX_B3BA5A5A87998E` (`origine_id`),
  ADD KEY `IDX_B3BA5A5AC54C8C93` (`type_id`);
...
ALTER TABLE `stock`
  ...
  ADD KEY `IDX_4B365660A17D8957` (`stock_produit_id`);
...
ALTER TABLE `user`
  ...
  ADD KEY `IDX_8D93D649AA2B41DC` (`lieu_vente_id`);
...
--
-- AUTO_INCREMENT pour la table `bannieres_entreprise`
--
ALTER TABLE `bannieres_entreprise`
...
--
-- AUTO_INCREMENT pour la table `epaisseurs`
--
ALTER TABLE `epaisseurs`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT pour la table `liaison_produit`
--
ALTER TABLE `liaison_produit`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `lieux_ventes`
--
ALTER TABLE `lieux_ventes`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT pour la table `liste_inventaire`
--
ALTER TABLE `liste_inventaire`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;

--
-- AUTO_INCREMENT pour la table `liste_stock`
--
ALTER TABLE `liste_stock`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT pour la table `mouvement_product`
--
ALTER TABLE `mouvement_product`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT pour la table `origine_produit`
--
ALTER TABLE `origine_produit`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `stock`
  ADD CONSTRAINT `FK_4B3656606C8A81A9` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`),
