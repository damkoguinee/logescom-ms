    ...
    <div style="display: flex;" >
      ...
      <div>
        ...
        if (!isset($_GET['ajout'])) {
          ...
          if ($_SESSION['level']>6) {
            $prodm=$DB->query("SELECT stock.id as id, nomstock, nombdd, nom, position, surface, nbrepiece, adresse from stock inner join login on login.id=coderesp  order by(nomstock)");
          }else{
          ...
          <table class="payement">
            <thead>
              ...
              <tr>
                ...
                <th height="25" colspan="9" style="text-align: center"><?='Liste des Stocks';?><a style="color: green; font-size: 30px; margin-left: 30px; color:orange;" href="stockgeneral1.php?stockgeneral=<?='stock general';?>&nomstock=<?=0;?>&recherche=<?=0;?>">Voir Stock Général</a><?php if ($_SESSION['type']=="admin") {?><a href="ajoutstock.php?ajout" style="color: orange; margin-left: 30px;">Ajouter un Stock</a><?php }?></th>
                  ...
                  <tr>
                    ...
                    <td colspan="1">
                      ...
                      <?php if ($products['statut']=='adminnnn') {?>
                        ...
                        <a href="ajoutstock.php?stock=<?=$formation->nombdd;?>&delete=<?=$formation->id;?>" onclick="return alerteS();"><input type="button" value="Supprimer" style="width: 95%; font-size: 16px; background-color: red; color: white; cursor: pointer"></a><?php 
                      }?>
                    </td>
